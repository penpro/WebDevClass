...
```bash
sudo mysql -e "USE hello_app; INSERT INTO messages (text) VALUES ('new row');"
```
...
- Browsers often default to HTTPS, so a raw EC2 deployment without certificates may require manually typing `http://PUBLIC_IP`
